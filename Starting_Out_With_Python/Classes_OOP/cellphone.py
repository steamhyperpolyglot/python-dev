...
class CellPhone:
	...
	# The set_manufact method accepts an argument for the
	...
	# The get_manufact method returns the phone's
	# manufacturer.

	def get_manufact( self ):
		return self.__manufact
	
	# The get_model method returns the phone's
	# model number.
	def get_model( self ):
		return self.__model
	
	# The get_retail_price method returns the phone's
	# retail price.
