...
def main():
    ...
    # Process menu selections until the user wants to
    # quit the program.
    while choice != QUIT:
...
# the get_menu_choice function displays the menu and gets a validated
...
# The change function changes an existing entry in the specified
# dictionary.
...
# The delete function deletes an entry from the specified
# dictionary.
...
# The save_contacts function pickles the specified object and
