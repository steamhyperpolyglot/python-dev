...
class SavingsAccount:
    ...
    # The __init__ method accepts arguments for the account number,
...
# The CD account represents a certificate of deposit (CD) account.
# It is a subclass of the SavingsAccount class.

class CD(SavingsAccount):

    # The init method accepts arguments for the account number,
    # interest rate, balance, and maturity date.
    ...
    # The set_maturity_date is a mutator for the __maturity_date
    # attribute.

    def set_maturity_date(self, mat_date):
        self.__maturity_date = mat_date
    
    # The get_maturity_date method is an accessor for the
