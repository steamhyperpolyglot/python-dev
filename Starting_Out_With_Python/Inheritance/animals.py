# The Mammal class represents a generic animal.
...
# The Dog class is a subclass of the Mammel class.
...
class Cat(Mammal):
    ...
    # The __init__ method calls the superclass's __init__
    # method passing 'Cat' as the species.
