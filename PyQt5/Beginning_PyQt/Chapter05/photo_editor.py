...
class PhotoEditor(QMainWindow):
	...
	def openImage(self):
		...
		Displau error message if image can't be opened.
		"""
	...
	def printImage(self):
		...
		if print_dialog.exec_() == QPrintDialog.Accepted:
			...
			# Get the size of the image_label and use it to set the size
			# of the viewport
	...
	def rotateImage180(self):
		...
		if not self.image.isNull():
			...
			# In order to allow the continued rotation of the image, set the
