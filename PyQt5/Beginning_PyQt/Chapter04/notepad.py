...
class Notepad(QWidget):
	...
	def clearText(self):
		"""
		If the new button is clicked, display dialog asking user
		if they want to clear the text edit field or not.
		"""
	...
	def saveText(self):
		"""
		If the save button is clicked, display dialog to save
		the text in the text edit field to a text field.
		"""
