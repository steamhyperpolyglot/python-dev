...
class PainterWindow(QMainWindow):
    ...
    def initializeUI(self):
        ...
        QToolTip.setFont(QFont('SF Pro Text', 12))
    ...
    def createToolbar(self):
        ...
        pencil_act.triggered.connect(lambda: self.canvas.selectDrawingTool("marker"))
    ...
    def leaveEvent(self, event):
        ...
        mouse coordinatees in status bar if mouse leaves the window.
        """
